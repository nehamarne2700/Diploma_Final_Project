...
public partial class Farmer_Upload : System.Web.UI.Page
{
    String data;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            SqlCommand cmd = new SqlCommand("select catname from Cat", con);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
       ...
       fname = "~/Files/" + url +".jpg";
        ...
        if (contenttype != String.Empty)
        {
            ...
            cmd.Parameters.AddWithValue("@ImgName", SqlDbType.VarChar).Value = filename;
            ...
            cmd.Parameters.AddWithValue("@Description", s1);
            ...
            cmd.Parameters.AddWithValue("@quan", s3);
         
            cmd.Parameters.AddWithValue("@imageurl", dburl);
            cmd.Parameters.AddWithValue("@Status", "-");
            cmd.Parameters.AddWithValue("@Uploadby", Nam);
            Session["Name"] = Nam;
