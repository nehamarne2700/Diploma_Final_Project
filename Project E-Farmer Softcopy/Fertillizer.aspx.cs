...
public partial class Fertillizer : System.Web.UI.Page
{
    String data;
    SqlConnection con = new SqlConnection();
    SqlCommand com;
    int i = 0;
    String st = "Fertilizer";
    int sd;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        for (int d = 1; d <= s; d++)
        {
            ...
            // image.Attributes.Add("PostBackUrl", "Laptop.aspx");
            image.Click += new System.Web.UI.ImageClickEventHandler(image_Click);
